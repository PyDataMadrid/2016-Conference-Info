function main() {
    ...
    var showSlideNumbers = function() {
        ...
        var hidden = asides[0].style.display != 'none';
        for (var i = 0; i < asides.length; i++) {
            asides.item(i).style.display = hidden ? 'none' : 'block';
        }
    };
	...
	var asides = document.getElementsByClassName('footer');
        var hidden = asides[0].style.display != 'none';
        for (var i = 0; i < asides.length; i++) {
            asides.item(i).style.display = hidden ? 'none' : 'block';
        }
